  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-[#FBC51A]/10 via-[#FB0091]/5 to-[#00B4EE]/10">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#00B4EE]/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#FBC51A]/20 rounded-full blur-3xl translate-x-1/3"></div>
