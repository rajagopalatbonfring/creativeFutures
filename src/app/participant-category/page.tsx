    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden bg-gradient-to-br from-[#00B4EE]/10 via-[#FB0091]/5 to-[#FBC51A]/10">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Choose your age group to see activities made just for you!
            </p>
          </motion.div>
        </div>
        {/* Wave */}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {ageGroupData.map((group, index) => (
              <Link key={group.age} href={`/participant-category/${group.age}`}>
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  <Card className="h-full hover:shadow-2xl transition-all duration-300 border-black/5 overflow-hidden group cursor-pointer hover:-translate-y-2 bg-white">
                    <CardHeader className="text-center pt-10 pb-6">
                      ...
                      <div className="pb-3">
                        <span className={`${group.color} px-5 py-2.5 rounded-full text-sm font-black`}>
                          Ages {group.age}
                        </span>
                      </div>
                      <CardTitle className="font-headline text-2xl font-bold mb-3">{group.stage}</CardTitle>
